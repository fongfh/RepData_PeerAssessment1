...
The daily mean is 9,354.23. 
The daily median is 10,395.

## What is the average daily activity pattern?

The average computed across each 3-minute interval and across all days can be computed by subsetting a new datframe using 'data$interval' and summarized by mean.
